<div class="row">
    ...
    <div class="col-lg-4 col-md-4">
        ...
        <div class="form-group">
            <select class="form-control" name="type" id="type" style="padding: 5px;">
    ...
    <div class="col-lg-4 col-md-4">
        ...
        <div class="form-group">
            <select class="form-control" name="includes" id="includes" style="padding: 5px;">
                <option value="">Seleccione una opción</option>
    ...
    {{-- <div class="col-lg-4 col-md-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="quantity" id="quantity" min="0" readonly />
        </div>
    </div>
    <div class="col-lg-4 col-md-4">
        <div class="form-group">
            <label class="font-weight-700">Precio unitario *</label>
            <input type="number" class="form-control" name="price_unit" id="price_unit" min="0" readonly />
        </div>
    </div>
    <div class="col-lg-4 col-md-4">
        <div class="form-group">
