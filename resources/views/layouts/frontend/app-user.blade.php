...
<head>
    ...
    {{-- <meta name="description" content="Job Board - Job Portal HTML Template + RTL" />
    <meta property="og:title" content="Job Board - Job Portal HTML Template + RTL" />
    <meta property="og:description" content="Job Board - Job Portal HTML Template + RTL" />
 ...
 <![endif]-->
    ...
    <link rel="stylesheet"
        href="{{ asset('dashboard/app-assets/css/plugins/bootstrap-tasginput/bootstrap-tagsinput.css') }}">
    <link rel="stylesheet"
        href="{{ asset('dashboard/app-assets/css/plugins/fontawesome-free/css/fontawesome.min.css') }}">
    {{-- <link rel="stylesheet" href="{{ asset('app/style.css') }}"> --}}
    {{-- <link href="{{ url('') . mix('css/all-frontend.css') }}" rel="stylesheet"> --}}
...
<body id="bg">
    ...
    <script src="{{ asset('dashboard/vendor/fontawesome-free/js/fontawesome.min.js') }}"></script>
    ...
    {{-- <script src="{{ url('') . mix('js/all-frontend.js') }}"></script> --}}
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            jQuery('#autonomous_community').removeClass('bs-select-hidden');
            // jQuery("a[href='https://1.envato.market/g56Wg']").removeClass('bt-buy-now theme-btn');
            // jQuery("a[href='https://support.w3itexperts.com']").removeClass('bt-support-now theme-btn');
        });
    </script>
</body>
