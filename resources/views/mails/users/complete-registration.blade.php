...
<head>
    ...
    <title>Completar Registro de Usuario</title>
</head>

<body>
    <h1>Hola {{ $user->first_name . ' ' . $user->last_name }}</h1>
    <p><a href="{{ route('client.complete-registration') . '?token=' . $user->token_complete }}">Completa tus datos</a>
    </p>
</body>
...
<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0" marginwidth="0" marginheight="0" width="100%"
 ...
 max-width: 560px;"
   ...
   font-family: sans-serif;"
                            class="subheader">
                            ENLACE PARA COMPLETAR EL REGISTRO DE SU CUENTA
                        </td>
                    </tr>
   ...
   font-family: sans-serif;"
                            class="paragraph">
                            Recientemente se te ha proporcionado un enlace para que completes tu registro y poder
                            postular tu proyecto. Para acceder debes darle click en el siguiente bot&oacute;n:
                        </td>
                    </tr>
   ...
   padding-top: 25px;
   padding-bottom: 5px;"
                            class="button"><a href="{{ route('client.complete') . '?token=' . $user->token_complete }}"
     ...
     color: #FFFFFF; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 120%;"
                                                href="{{ route('client.complete') . '?token=' . $user->token_complete }}">
                                                Ir a completar
                                            </a>
                                        </td>
                                    </tr>
   ...
   padding-top: 25px;"
     ...
     font-family: sans-serif;"
                                        class="paragraph">
                                        Si el botón para ir a completar tu registro no funciona por favor copia y pega
                                        el
                                        siguiente enlace en tu navegador <span
                                            style="font-size:11px;">{{ route('client.complete') . '?token=' . $user->token_complete }}
                                        </span>
