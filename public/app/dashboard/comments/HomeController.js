...
tblData = $('#dataTable').DataTable({
    ...
    columns: [
        ...
        {data: 'departure.project.code', name: 'departure.project.code', orderable: true, searchable: true},
        {data: 'departure.code', name: 'departure.code', orderable: true, searchable: true},
        {data: 'departure.project.user.company_name', name: 'departure.project.user.company_name', orderable: true, searchable: true},
        {data: 'description', name: 'description', orderable: true, searchable: true},
        {data: 'user.company_name', name: 'user.company_name', orderable: true, searchable: true},
    ...
    columnDefs: [
        ...
        }},
        {
            ...
            return row.departure.project.code
        }},
        {
            targets: 2, render: function ( data, type, row, meta ) {
            return row.departure.code;
        }},
        {
        ...
        }},
        {
            ...
            return row.departure.project.user.company_name;
        }},
        {
...
//                 '',
//                 '',
//                 $('#frmVariableNew select[id=status]').val(),
//                 ]).draw();
...
//                         $('#frmVariableNew select[id=type]').val(), // type
//                         '',
//                         $('#frmVariableNew textarea[id=text]').summernote('code'),
//                         '',
...
//           tableVariableDataEdit.cell($('#frmVariableEdit input[id=index]').val(), 11).data($('#frmVariableEdit select[id=status]').val());
...
//           tableVariableDataEdit.cell($('#frmVariableEdit input[id=index]').val(), 5).data($('#frmVariableEdit select[id=type]').val());
//           tableVariableDataEdit.cell($('#frmVariableEdit input[id=index]').val(), 6).data('');
//           tableVariableDataEdit.cell($('#frmVariableEdit input[id=index]').val(), 7).data($('#frmVariableEdit textarea[id=text]').summernote('code'));
//           tableVariableDataEdit.cell($('#frmVariableEdit input[id=index]').val(), 8).data($('#frmVariableEdit input[id=id]').val());
...
//       console.log(moment(res.data.data.execution_date).format('DD/MM/YYYY'));
