...
var JobBoard = function(){
	...
	var handleBootstrapSelect = function(){
		...
		if (jQuery('select').length) {
			if(jQuery('#frmCompleteRegistration').length || jQuery('#frmNew').length || jQuery('#frmVariantNew') || jQuery('#frmSearch')){}
			else{
